...
<!-- default badges end -->
# DevExtreme - Implement Adaptivity Using DataGrid and CardView
...
- Implement the same [data store](https://js.devexpress.com/Documentation/Guide/Data_Binding/Data_Layer/#Creating_DataSource/What_Are_Stores) in both components to share data between them. To update data, call the store's [push](https://js.devexpress.com/Documentation/Guide/Data_Binding/Data_Layer/#Data_Modification/Integration_with_Push_Services) method in [DataGrid.onSaved](https://js.devexpress.com/Documentation/ApiReference/UI_Components/dxDataGrid/Configuration/#onSaved) and [CardView.onSaved](https://js.devexpress.com/Documentation/ApiReference/UI_Components/dxCardView/Configuration/#onSaved) event handler.
